...
(cl:defmethod cl:initialize-instance :after ((m <VacuumGripperState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VacuumGripperState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nist_gear-msg:<VacuumGripperState> is deprecated: use nist_gear-msg:VacuumGripperState instead.")))
...
(cl:defmethod attached-val ((m <VacuumGripperState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:attached-val is deprecated.  Use nist_gear-msg:attached instead.")
  (attached m))
