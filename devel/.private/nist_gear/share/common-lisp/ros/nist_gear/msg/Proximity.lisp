...
(cl:defmethod cl:initialize-instance :after ((m <Proximity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Proximity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nist_gear-msg:<Proximity> is deprecated: use nist_gear-msg:Proximity instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Proximity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:header-val is deprecated.  Use nist_gear-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'object_detected-val :lambda-list '(m))
(cl:defmethod object_detected-val ((m <Proximity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:object_detected-val is deprecated.  Use nist_gear-msg:object_detected instead.")
  (object_detected m))

(cl:ensure-generic-function 'min_range-val :lambda-list '(m))
(cl:defmethod min_range-val ((m <Proximity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:min_range-val is deprecated.  Use nist_gear-msg:min_range instead.")
  (min_range m))

(cl:ensure-generic-function 'max_range-val :lambda-list '(m))
(cl:defmethod max_range-val ((m <Proximity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:max_range-val is deprecated.  Use nist_gear-msg:max_range instead.")
  (max_range m))
