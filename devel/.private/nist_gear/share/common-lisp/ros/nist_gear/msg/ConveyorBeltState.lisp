...
(cl:defmethod cl:initialize-instance :after ((m <ConveyorBeltState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConveyorBeltState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nist_gear-msg:<ConveyorBeltState> is deprecated: use nist_gear-msg:ConveyorBeltState instead.")))

(cl:ensure-generic-function 'power-val :lambda-list '(m))
(cl:defmethod power-val ((m <ConveyorBeltState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:power-val is deprecated.  Use nist_gear-msg:power instead.")
  (power m))
