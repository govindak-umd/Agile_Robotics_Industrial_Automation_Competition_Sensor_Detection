...
(cl:defclass <LogicalCameraImage> (roslisp-msg-protocol:ros-message)
  ((models
    :reader models
    :initarg :models
    :type (cl:vector nist_gear-msg:Model)
   :initform (cl:make-array 0 :element-type 'nist_gear-msg:Model :initial-element (cl:make-instance 'nist_gear-msg:Model)))
   (pose
    :reader pose
    :initarg :pose
...
(cl:defmethod cl:initialize-instance :after ((m <LogicalCameraImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LogicalCameraImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nist_gear-msg:<LogicalCameraImage> is deprecated: use nist_gear-msg:LogicalCameraImage instead.")))

(cl:ensure-generic-function 'models-val :lambda-list '(m))
(cl:defmethod models-val ((m <LogicalCameraImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nist_gear-msg:models-val is deprecated.  Use nist_gear-msg:models instead.")
  (models m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LogicalCameraImage>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'models)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'nist_gear-msg:Model))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LogicalCameraImage>)))
  ...
  (cl:format cl:nil "# Logical camera image message~%Model[] models                  # models detected (poses in the frame of the camera)~%geometry_msgs/Pose pose         # camera pose~%~%================================================================================~%MSG: nist_gear/Model~%string type                     # model type~%geometry_msgs/Pose pose         # model pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LogicalCameraImage)))
  "Returns full string definition for message of type 'LogicalCameraImage"
  (cl:format cl:nil "# Logical camera image message~%Model[] models                  # models detected (poses in the frame of the camera)~%geometry_msgs/Pose pose         # camera pose~%~%================================================================================~%MSG: nist_gear/Model~%string type                     # model type~%geometry_msgs/Pose pose         # model pose~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
